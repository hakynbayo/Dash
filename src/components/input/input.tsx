    ...
    <div className='w-full'>
      <div className='flex flex-col gap-2'>
        ...
        {type === 'password' && (
          <div
            className={cn(
              ' relative flex w-full flex-row items-center rounded-[4px] text-xs transition-all duration-300 ease-linear md:text-sm lg:text-base',
              [
        ...
        {(type === 'email' || type === 'date' || type === 'text') && (
          <div
            className={cn(
              ' flex w-full flex-row items-center rounded-[4px] text-xs transition-all duration-300 ease-linear md:text-sm lg:text-base',
              [
                variant === 'primary' && ' bg-white',
                variant === 'secondary' && 'bg-secondary-grey',
              ],
